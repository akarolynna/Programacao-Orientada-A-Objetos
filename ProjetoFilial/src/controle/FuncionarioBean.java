...
public class FuncionarioBean {
	...
	/*Colocamos aqui, pois queremos que a mensagem apareça assim que ele clica no botão editar e é este método que está sendo
		chamado lá no nosso botão editar
		*/
		FacesContext.getCurrentInstance().
		addMessage("msg2", new FacesMessage("Não é possível alterar a filial em que você está cadastrado, por isso, o campo da filial está desabilitado!"));
        funcionario = func;
		gravar = false;
	}
